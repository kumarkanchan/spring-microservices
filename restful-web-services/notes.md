...
## Social Application Resource Mappings
...
class com.rest.webservices.HelloWorldBean
```
...
public java.lang.String com.rest.webservices.HelloWorldController.helloWorld()
- Mapped "{[/hello-world-bean],methods=[GET]}" onto 
public com.rest.webservices.HelloWorldBean com.rest.webservices.HelloWorldController.helloWorldBean()
- Mapped "{[/error]}" onto 
...
```java
	public static final Contact DEFAULT_CONTACT = new Contact(
			"Vikas Singh Rathore ", "http://www.in28minutes.com", "vikaskanvika@gmail.com");
